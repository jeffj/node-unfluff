...
(function() {
  ...
  module.exports = {
    date: function(doc) {
      ...
      return ((ref = cleanNull(dateCandidates != null ? (ref1 = dateCandidates.first()) != null ? ref1.attr("content") : void 0 : void 0)) != null ? ref.trim() : void 0) || ((ref2 = cleanNull(dateCandidates != null ? (ref3 = dateCandidates.first()) != null ? ref3.attr("datetime") : void 0 : void 0)) != null ? ref2.trim() : void 0) || cleanText(dateCandidates != null ? (ref4 = dateCandidates.first()) != null ? ref4.text() : void 0 : void 0) || null;
    },
    ...
    author: function(doc) {
      ...
      authorCandidates.each(function() {
        var author, ref, ref1;
        author = (ref = cleanNull((ref1 = doc(this)) != null ? ref1.attr("content") : void 0)) != null ? ref.trim() : void 0;
        if (author) {
    ...
    publisher: function(doc) {
      ...
      return ((ref = cleanNull(publisherCandidates != null ? (ref1 = publisherCandidates.first()) != null ? ref1.attr("content") : void 0 : void 0)) != null ? ref.trim() : void 0) || null;
    },
    title: function(doc) {
      var titleText;
    ...
    html: function(doc, topNode, lang) {
      var html;
      if (topNode) {
        topNode = postCleanup(doc, topNode, lang);
        html = true;
        return formatter(doc, topNode, lang, html);
      } else {
        return "";
      }
    },
    ...
    description: function(doc) {
      ...
      return (ref = cleanNull(tag != null ? (ref1 = tag.first()) != null ? ref1.attr("content") : void 0 : void 0)) != null ? ref.trim() : void 0;
    },
    keywords: function(doc) {
      var tag;
      tag = doc("meta[name=keywords]");
      return cleanNull(tag != null ? tag.attr("content") : void 0);
    },
    canonicalLink: function(doc) {
      var tag;
      tag = doc("link[rel=canonical]");
      return cleanNull(tag != null ? tag.attr("href") : void 0);
    },
    tags: function(doc) {
      var elements, tags;
    ...
    calculateBestNode: function(doc, lang) {
      ...
      _.each(nodesWithText, function(node) {
        var boostScore, booster, negscore, parentFourNode, parentNode, parentParentNode, parentParentParentNode, textNode, upscore, wordStats;
        boostScore = 0.0;
  ...
  cleanNull = function(text) {
    return text != null ? text.replace(/^null$/g, "") : void 0;
  };
